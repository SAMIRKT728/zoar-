...
import ValidaEstudiante from '../../../../../validaciones/validarEstudiante'; // Importar la función de validación
import UserRegistro from '../../../../authentication/sign-up/components/formRegistro';
...
const FormDocentes = () => {
 ...
 useEffect(() => {
  ...
  const handleSubmit = async (ev) => {
    ...
    const validacion = ValidaEstudiante({
      Cedula,
      nombre,
      apellido,
      correo,
   ...
   const mensajes = validacion.map((mensaje, index) => (
      ...
      setAlerta({ open: true, message: mensajes, type: 'error' });
      return;
    }
  ...
  return (
    <Grid2 container spacing={0} sx={{ padding: '0', margin: '0' }}>
      <div>
              ...
              >
                ...
                >
                  <Stack spacing={1} alignItems="center">
                    <AddAPhotoIcon sx={{ fontSize: 25, color: 'grey' }} />
                    <Box sx={{ fontSize: 12, color: 'grey' }}>Subir Foto</Box>
                  </Stack>
